/* SELF ASSESSMENT
 ...
 3. Did I write the determineStarNumber or determineTriangleNumber function correctly (parameters, return type and function body) and invoke it correctly?
       Mark out of 20: 20
       Wrote a determineTriangleNumber function that took a number n and returned an int value of the nth triangle number
 ...
 6. Did I loop through all possibilities in the program using system defined constants to determine when to stop?
       Mark out of 10: 10
       Made the star number a long value and because the triangular number will never be able to wrap around to a positive value there is no need to use any system constants.
