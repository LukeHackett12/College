...
set CLASSPATH=%APP_HOME%\lib\controller-1.0-SNAPSHOT.jar;%APP_HOME%\lib\groovy-all-2.3.11.jar

@rem Execute controller
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CONTROLLER_OPTS%  -classpath "%CLASSPATH%" Controller %CMD_LINE_ARGS%
